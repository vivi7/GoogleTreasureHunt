...
public class CheckAndXView: UIView {
    ...
    public func setIsDone(isDone: Bool){
        self.isDone = isDone
    }
    ...
    public func drawCheck(completion: (() -> Void)?) {
        ...
        if isDone{
            ...
            path.moveToPoint(
                CGPointMake(canvasFrame.origin.x, canvasFrame.origin.y + canvasFrame.height))
            path.addLineToPoint(
                CGPointMake(canvasFrame.origin.x + canvasFrame.width, canvasFrame.origin.y))
            path.moveToPoint(
                CGPointMake(canvasFrame.origin.x, canvasFrame.origin.y))
            path.addLineToPoint(
                CGPointMake(canvasFrame.origin.x + canvasFrame.width, canvasFrame.origin.y + canvasFrame.height))
        }
